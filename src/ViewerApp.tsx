...
import { createNewViewerAppState, IViewerAppState } from './model/IViewerAppState';
...
export class ViewerApp {
    ...
    run() {
        this.appState = restoreAppState(this.localStorageSaveKey,createNewViewerAppState);
